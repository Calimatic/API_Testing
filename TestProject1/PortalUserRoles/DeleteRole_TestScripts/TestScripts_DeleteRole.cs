...
namespace TestProject1.PortalUserRoles.DeleteRole_TestScripts
{
    [TestClass]
    public class TestScripts_DeleteRole
    {
        [TestMethod]
        public void ValidInputValues()
        {
            var AddUpdateRoles_GetResponse = ApiResponse_AddUpdateRoles.sets_AddUpdateRoles;
            Console.WriteLine("Get Deleted Successfully            :   PASS");
            Assert.AreEqual(200, AddUpdateRoles_GetResponse.statusCode, "Unexpected status code.");
        }
        [TestMethod]
        ...
        public void ContainsAlphabetValue(string id)
        {
            ...
            Console.WriteLine("Get Deleted Successfully                                        :       FAIL");
