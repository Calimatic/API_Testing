...
namespace TestProject1.PortalUserRoles.AddUpdateRoleAccess_TestScripts
{
    [TestClass]
    public class TestScripts_AddUpdateRoleAccess
    {
        [TestMethod]
        public void ValidInputValues()
        {
            ...
            Assert.AreEqual(200, AddUpdateRoleAccess_GetResponse.statusCode, "Unexpected status code.");
        }
        [TestMethod]
