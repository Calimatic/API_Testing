...
namespace TestProject1.Company.ResendActivationEmail_TestScripts
{
    [TestClass]
    public class TestScripts_ResendActivationEmail
    {
        [TestMethod]
        public void ValidInputValues()
        {
            var ResendActivationEmail_GetResponse = ApiResponse_ResendActivationEmail_Response.sets_ResendActivationEmail;
            Console.WriteLine("Get Response Successfully            :   PASS");
            Assert.AreEqual(200, ResendActivationEmail_GetResponse.statusCode, "Unexpected status code.");
        }
        [TestMethod]
