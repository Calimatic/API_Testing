...
namespace ApiTesting_Calimatic.Department.deleteDepartments_RF
{
    public class deleteDepartments_DataRead
    {
        public List<saveDepartment_InputParams> Getfile_deleteDepartments()
        {
            ...
            string relativePath = Path.Combine(projectPath, "Dataset_files", "deleteDepartment.csv");
