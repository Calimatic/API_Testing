...
namespace ApiTesting_Calimatic.Dashboard_RF.EventDropOffCountByType_RF
{
    public class EventDropOffCountByType_DataRead
    {
        public List<ClassDropOffCountByType_data> Getfile_EventDropOffCountByType()
        {
            ...
            string relativePath = Path.Combine(projectPath, "Dataset_files", "EventDropOffCountByType.csv");
